...
| Current release | collection-sanity | rhel-9 | ansible-core, molecule, incus | Collection sanity | See GitHub Release evidence |
| Current release | molecule-light | rhel-9 | ansible-core, molecule, incus | Molecule light | See GitHub Release evidence |
| Current release | molecule-heavy-incus | rhel-9 | ansible-core, molecule, incus | Heavy Incus | See GitHub Release evidence |
| Current release | galaxy-build | rhel-9 | ansible-core, molecule, incus | Galaxy build/publish | See GitHub Release evidence |
| Current release | collection-sanity | rhel-10 | ansible-core, molecule, incus | Collection sanity | See GitHub Release evidence |
| Current release | molecule-light | rhel-10 | ansible-core, molecule, incus | Molecule light | See GitHub Release evidence |
| Current release | molecule-heavy-incus | rhel-10 | ansible-core, molecule, incus | Heavy Incus | See GitHub Release evidence |
| Current release | galaxy-build | rhel-10 | ansible-core, molecule, incus | Galaxy build/publish | See GitHub Release evidence |
